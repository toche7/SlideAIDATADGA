...
- สามารถเขียนใน Colab หรือ ChatGPT/Gemini ได้เลย
...
โดยเขียนใน Text Cell ต่อท้ายจากการวิเคราะห์ข้อมูลใน Colab
```
...
### ตัวอย่าง Prompt สำหรับรายงานส่วน 3-6
```prompt
...
---
Propmt (Gemini / ChatGPT)

```prompt
Create  slides including ; 
Slide 1: สถานการณ์รวม (KPI card)
Slide 2: แนวโน้มเวลารอรายจังหวัด (line chart)
Slide 3: ออนไลน์ vs ความพึงพอใจ (scatter plot)
Slide 4: ข้อเสนอเชิงนโยบายพร้อมตัวชี้วัดติดตามผล
...
--- 
## 4) การสร้าง Onepage Info Graphic ด้วย AI

กระบวนการทำงานที่แนะนำ
1. สรุป Insight สำคัญจากรายงานและ Executive Summary
2. ให้ AI ช่วยออกแบบ Layout และเลือกกราฟที่เหมาะสม
3. ตรวจสอบความถูกต้องของตัวเลขและข้อความอีกครั้ง
4. ปรับแต่งสีและฟอนต์ให้สอดคล้องกับ CI ของหน่วยงาน
5. ส่งไฟล์ PDF หรือ PNG ให้ผู้บริหารใช้ประกอบการตัดสินใจ


---
## ตัวอย่าง: Onepage Info Graphic สำหรับผู้บริหาร

1. ใช้ usecase: สรุปผลการวิเคราะห์บริการประชาชน 4 จังหวัด (ข้อมูล 6 เดือน)
2. ให้การวิเคราะห์ต่างๆ ตามกระบวนการก่อนหน้า หรือให้ทำต่อกจากที่เคยทำไว้แล้ว
3. มีการสรุป Insight สำคัญและข้อเสนอเชิงนโยบาย พร้อมตัวชี้วัดติดตามผล
4. ให้ AI ช่วยออกแบบ Layout และเลือกกราฟที่เหมาะสม
...
<div class ="columns">
  <div class="column" style="width: 50%;">
    <img src="../fig/onepage1.png" alt="Onepage Info Graphic" width="500">
  </div>
  <div class="column" style="width: 50%;">
    <img src="../fig/onepage2.png" alt="Onepage Info Graphic" width="500">
  </div>

---

## 5) เทคนิคการสื่อสารเพื่อการตัดสินใจ
